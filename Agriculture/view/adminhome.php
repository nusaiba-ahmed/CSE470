...
$(document).ready(function(){
 ...
 checkbox.click(function(){
  ...
  var selectedString = selected.join(",");
        $.post("delete.php", {selected: selected },
        function(data){
...
<form action="https://termly.io/products/privacy-policy-generator/" class="form_design1" method="post">

  
<input type="submit" name="submit" value="EDIT POLICY"> 

</form>
<form action="question.php" class="form_design2" method="post">

  
<input type="submit" name="submit" value="QUESTIONS "> 
