...
?>
<?php
include "../model/cal_exp.php";
include "../model/cal_sensorlevel.php";
?>
...
require_once("../controller/db_con.php");
  $username=$_SESSION['username'];
   $sql1="SELECT * FROM queries WHERE queryuser='$username'";
...
if(mysqli_num_rows($result1) != 0){
  ...
  ?>
  <div class=row>
  <div class="col-md-2"style="font-size: 2rem; font-weight: 800; color:azure;"><?php echo $row1[1]; ?></div>
     <div class="col-md-2"style="font-size: 2rem; font-weight: 800; color:azure;"><?php echo $row1[3]; ?></div>
...
<!-- Trigger the modal with a button -->
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1">Suggested Crops </button>
...
<div class="modal fade" id="myModal1" role="dialog">
  ...
  <ul class="responsive-table">
    <li class="table-header">
      ...
      <div class="col col-1">Suggestions</div>
    </li>
    </ul>
    </div>
      <?php
     include "../controller/con_location.php";
?>
...
<!-- Trigger the modal with a button -->
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal8">Sensor Status </button>
...
<div class="modal fade" id="myModal8" role="dialog">
  ...
  <ul class="responsive-table">
    <li class="table-header">
      <div class="col col-1">Water Level</div>
      <div class="col col-1">Nitrogen Level</div>
    </li>
    </ul>
    </div>
      <?php
     include"../controller/connect_sensor.php";
...
<form action="ADDINVENTORY.php" class="form_design1" method="post">
...
<form action="../view/Update.php" class="form_design2" method="post">
